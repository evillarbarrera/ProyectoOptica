...
class UserStoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_store" do
    assert_difference('UserStore.count') do
      post user_stores_url, params: { user_store: { store_id: @user_store.store_id, user_id: @user_store.user_id } }
    end
  ...
  test "should update user_store" do
    patch user_store_url(@user_store), params: { user_store: { store_id: @user_store.store_id, user_id: @user_store.user_id } }
